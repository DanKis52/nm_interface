...
cond_l = tk.Label(text='Начальные условия', bg='#ececec').grid(row=2, column=0, columnspan=2, sticky='sw', padx=10)
rb_var = tk.IntVar()
rb1 = tk.Radiobutton(text='1', variable=rb_var, value=1, bg='#ececec').grid(row=3, column=0, sticky='nw', padx=10)
rb2 = tk.Radiobutton(text='-1', variable=rb_var, value=-1, bg='#ececec').grid(row=3, column=1, sticky='nw', padx=10)
exec_b = tk.Button(text='Вычислить', bg='#ececec', highlightbackground='#cbcbcb').grid(row=4, column=0, columnspan=2,
                                                                                       rowspan=2, sticky='news',
                                                                                       padx=10, pady=10)
exit_b = tk.Button(text='Выход', bg='#ececec', highlightbackground='#cbcbcb').grid(row=6, column=0, columnspan=2,
                                                                                   rowspan=2, sticky='news', padx=10,
                                                                                   pady=10)
# input frame
...
step_l = tk.Label(text='Начальный шаг', bg='#ececec').grid(row=6, column=2, sticky='ws', padx=10)
